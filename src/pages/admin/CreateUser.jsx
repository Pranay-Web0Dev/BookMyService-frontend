...
const CreateUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Remove location if not provided or if coordinates are empty
    if (!showLocation || 
        !submitData.location.coordinates[0] || 
        !submitData.location.coordinates[1]) {
      delete submitData.location;
    } else {
      // Convert coordinates to numbers
      submitData.location.coordinates = [
        parseFloat(submitData.location.coordinates[0]),
        parseFloat(submitData.location.coordinates[1])
      ];
    }
